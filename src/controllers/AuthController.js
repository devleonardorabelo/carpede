...
module.exports = {
    ...
    async signin(req, res) {
		...
		if (deviceToken !== store.firebaseTokenNotification) {
			await Store.updateOne({_id: store.id},{firebaseTokenNotification: deviceToken});
		}
    ...
    async signup(req, res) {
			...
			const { avatar, name, whatsapp, email, password, operation, averageDeliveryTime, deviceToken } = req.body;
